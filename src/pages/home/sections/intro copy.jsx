...
const Intro = ()=>{
    ...
    <div className="intro gap-5 px-5  sm:px-16 md:px-32 py-5 md:py-10 lg:py-20">
            ...
            <div  className="w-full flex flex-col gap-5 ">
                    ...
                    <p>We enable businesses to evolve, scale, and lead by delivering intelligent, future-ready ICT solutions. As a trusted technology partner, we craft tailored strategies that fuse technical excellence with business insight, ensuring seamless integration of complex systems and mission-critical architectures. Our solutions are designed to accelerate performance, enhance agility, and unlock new growth opportunities in an increasingly digital world.</p>
                    <div><Link to="/solutions/digital-transformation"><span className="learn">Learn More</span></Link></div>
            </div>
    </div>
        <div className="intro gap-5 px-5  sm:px-16 md:px-32 py-5 md:py-10 lg:py-20">
            <div style={{position:"relative",height:"400px"}} className="w-full flex flex-col gap-2 ">
                <div className="flex gap-2">
                    <div><img className="one" src={img_1} alt="intelligent" /></div>
                    <div><img className="two"  src={img_2} alt="digital" /></div>
                </div>
                <div className="flex gap-2">
                    <div><img className="three" src={img_3} alt="intelligent" /></div>
                    <div><img className="four"  src={img_4} alt="digital" /></div>
                </div>
                <Link to="/solutions/digital-transformation"><div className={`icon-center ${isTrigger?"animate-icon":""} cursor-pointer`}>    
                       <div>
                         <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 68 68" fill="none">
