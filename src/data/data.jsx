...
export const solutionData = {
    title : "",
    description : <div>At INTELLECTRA, we empower organizations to navigate digital disruption, accelerate innovation, and achieve strategic goals through future-ready ICT solutions. As a trusted technology partner, we specialize in delivering tailored digital transformation strategies that align with each industry’s unique needs, whether it’s modernizing legacy systems, enabling cloud-first architectures, implementing robust cybersecurity frameworks, or deploying intelligent automation and IoT integrations. </div>,
...
export const industryData = {
    title : "",
    description : <div>At INTELLECTRA, we are at the forefront of digital transformation, delivering future-ready, technology-driven solutions that empower organizations to adapt, innovate, and lead in an increasingly dynamic and competitive world. Our deep industry expertise spans sectors such as real estate, manufacturing, education, healthcare, defense, retail, and beyond, enabling us to tailor intelligent IT strategies that solve complex business challenges with precision and agility.</div>,
